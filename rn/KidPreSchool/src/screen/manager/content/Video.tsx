...
const Video = () => {
  ...
  const navigation = useNavigation<VideoContentPageNavProps>();
  const handleDelete = (item: any) => {};
  const handleDetail = () => {
    navigation.navigate('VideoDetailContentPage');
  };
  const renderItem = ({ item }: { item: LearningInFo }) => {
    // console.log(item);
    return (
      <TouchableOpacity style={styles.list} onPress={() => handleDetail()}>
